...
exports.getEventByUserId = exports.findAndUpdateStatus = exports.findAndUpdate = exports.getOrderById = exports.findAndUpdateExchangeRates = exports.getExchangeRates = exports.ExchangeRateSchema = exports.EventSchema = exports.Order = exports.connect = undefined;
...
var getEventByUserId = function getEventByUserId(_userId) {
  return new Promise(function (resolve, reject) {
    return _event_schema2.default.find({
      'payment.partner_end_user_id': _userId
    }).sort({ '_id': -1 }).limit(1).exec(function (err, res) {
      if (err) reject(err);else resolve(res);
    });
  });
};
